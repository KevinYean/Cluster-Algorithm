...
{
    /// <summary>
    /// Maximum between-Cluster distance.
    /// </summary>
    public class CompleteLinkage : Linkage
    {
        ...
        public CompleteLinkage(int newK, List<DataPoint> newDataList) : base(newK, newDataList)
        {

        }

        /// <summary>
        /// Runs Complete Linkage
        /// </summary>
        public void Run()
        {
